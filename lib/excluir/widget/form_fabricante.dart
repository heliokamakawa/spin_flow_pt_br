...
import 'package:spin_flow/excluir/widget/componentes/borda_com_titulo.dart';
import 'package:spin_flow/excluir/widget/componentes/campos/comum/campo_email.dart';
import 'package:spin_flow/excluir/widget/componentes/campos/comum/campo_telefone.dart';
...
class _FormFabricanteState extends State<FormFabricante> {
      ...
      return Scaffold(
        appBar: AppBar(
          title: const TituloAppBarSpinFlow(
            contexto: 'Erro ao carregar fabricante',
          ),
        ),
        body: const Center(
          child: Text('Não foi possível carregar os dados do fabricante.'),
        ),
      );
    }
    return Scaffold(
  ...
  DTOFabricante _criarDTO() {
    return DTOFabricante(
      ...
      descricao: _descricaoControlador.text.isEmpty
          ? null
          : _descricaoControlador.text,
      nomeContatoPrincipal: _responsavelControlador.text.isEmpty
          ? null
          : _responsavelControlador.text,
      emailContato: _emailControlador.text.isEmpty
          ? null
          : _emailControlador.text,
      telefoneContato: _telefoneControlador.text.isEmpty
          ? null
