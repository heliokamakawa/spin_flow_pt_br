...
class _FormAlunoState extends State<FormAluno> {
          ...
          child: Column(
            children: [
              ...
              CampoUrl(
                ...
                prefixoIcone: const Icon(Icons.facebook, color: CoresApp.info),
              ),
              const SizedBox(height: 12),
              CampoUrl(
                rotulo: 'TikTok',
  ...
  Future<void> _salvar() async {
    if (_chaveFormulario.currentState!.validate()) {
      if (_nomeControlador.text.isEmpty ||
          _emailControlador.text.isEmpty ||
          (_genero ?? '').isEmpty ||
          _telefoneControlador.text.isEmpty) {
