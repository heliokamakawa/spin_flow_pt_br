      ...
      return Scaffold(
        appBar: AppBar(
          title: const TituloAppBarSpinFlow(
            contexto: 'Erro ao carregar artista/banda',
          ),
        ),
        body: const Center(
          child: Text('Não foi possível carregar os dados do artista/banda.'),
        ),
      );
    }
    return Scaffold(
  ...
  Future<void> _salvar() async {
    if (_chaveFormulario.currentState!.validate()) {
      try {
        ...
        _mostrarMensagem(
          _id != null
              ? 'Artista/Banda atualizado(a) com sucesso!'
              : 'Artista/Banda criado(a) com sucesso!',
        );
        if (_id == null) {
          _limparCampos();
        }
