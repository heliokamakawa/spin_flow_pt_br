...
class DAOArtistaBandaSQLite implements IDAOArtistaBanda {
  ...
  @override
  Future<List<ModeloArtistaBanda>> buscarTodos() async {
  ...
  @override
  Future<List<ModeloArtistaBanda>> buscarAtivos() async {
    final db = await ConexaoSQLite.database;
  ...
  @override
  Future<ModeloArtistaBanda?> buscarPorId(int id) async {
    final db = await ConexaoSQLite.database;
  ...
  @override
  Future<int> salvar(ModeloArtistaBanda artista) async {
    final db = await ConexaoSQLite.database;
    final dados = {
      'nome': artista.nome,
  ...
  ModeloArtistaBanda _mapParaModelo(Map<String, dynamic> map) {
    return ModeloArtistaBanda(
      id: map['id'] as int?,
