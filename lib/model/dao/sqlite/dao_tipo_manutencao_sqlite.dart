...
class DAOTipoManutencaoSQLite implements IDAOTipoManutencao {
  ...
  @override
  Future<List<ModeloTipoManutencao>> buscarTodos() async {
  ...
  @override
  Future<void> salvar(ModeloTipoManutencao tipo) async {
    final db = await ConexaoSQLite.database;
    final dados = {
      'nome': tipo.nome,
  ...
  ModeloTipoManutencao _mapear(Map<String, dynamic> map) =>
      ModeloTipoManutencao(
        id: map['id'] as int?,
