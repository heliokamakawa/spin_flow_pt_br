...
class DAOManutencaoSQLite implements IDAOManutencao {
  ...
  @override
  Future<List<ModeloManutencao>> buscarTodos() async {
  ...
  @override
  Future<ModeloManutencao?> buscarPorId(int id) async {
    final db = await ConexaoSQLite.database;
  ...
  @override
  Future<void> salvar(ModeloManutencao m) async {
    final db = await ConexaoSQLite.database;
  ...
  @override
  Future<ModeloManutencao?> buscarManutencaoAtivaPorBikeId(int bikeId) async {
    final db = await ConexaoSQLite.database;
    final maps = await db.query(
      _tabela,
      where:
  ...
  ModeloManutencao _mapear(Map<String, dynamic> map) => ModeloManutencao(
    id: map['id'] as int?,
