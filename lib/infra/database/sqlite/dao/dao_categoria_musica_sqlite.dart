...
class DAOCategoriaMusicaSQLite implements IDAOCategoriaMusica {
  ...
  @override
  Future<List<CategoriaMusica>> buscarTodos() async {
  ...
  @override
  Future<List<CategoriaMusica>> buscarAtivas() async {
    final db = await ConexaoSQLite.database;
  ...
  @override
  Future<CategoriaMusica?> buscarPorId(int id) async {
    final db = await ConexaoSQLite.database;
  ...
  @override
  Future<CategoriaMusica?> buscarPorNome(String nome) async {
    final db = await ConexaoSQLite.database;
  ...
  @override
  Future<int> salvar(CategoriaMusica categoria) async {
    final db = await ConexaoSQLite.database;
    final dados = {
      'nome': categoria.nome,
  ...
  CategoriaMusica _mapParaModelo(Map<String, dynamic> map) {
