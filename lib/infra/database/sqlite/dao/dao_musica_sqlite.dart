...
class DAOMusicaSQLite implements IDAOMusica {
  ...
  @override
  Future<List<Musica>> buscarTodos() async {
  ...
  @override
  Future<List<Musica>> buscarAtivas() async {
    final db = await ConexaoSQLite.database;
    final maps = await db.rawQuery('''
      SELECT m.id, m.nome, m.descricao, m.artista_id, m.ativo,
             a.nome AS artista_nome
  ...
  @override
  Future<int> salvar(Musica musica) async {
    final db = await ConexaoSQLite.database;
    final dados = {
      'nome': musica.nome,
  ...
  @override
  Future<List<CategoriaMusica>> buscarCategorias(int musicaId) async {
    final db = await ConexaoSQLite.database;
    final maps = await db.rawQuery(
      '''
  ...
  @override
  Future<List<VideoAula>> buscarVideos(int musicaId) async {
    final db = await ConexaoSQLite.database;
    final maps = await db.rawQuery(
      '''
