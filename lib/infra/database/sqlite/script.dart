class ScriptSQLite {
  ...
  static const List<String> _insercoesAulaRealizada = [
    ...
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-02-02T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-02-04T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-02-06T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Cadencia Manha 09h' LIMIT 1), '2026-02-07T09:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-02-10T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-02-11T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-02-13T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-02-17T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-02-18T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-02-20T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Cadencia Manha 09h' LIMIT 1), '2026-02-21T09:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-02-25T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-03-02T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-03-04T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-03-05T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-03-06T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-03-09T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Cadencia Manha 09h' LIMIT 1), '2026-03-14T09:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-03-17T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-03-18T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-03-20T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-03-24T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-03-25T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-03-27T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-04-01T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-04-02T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-04-03T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-04-06T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Cadencia Manha 09h' LIMIT 1), '2026-04-11T09:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-04-14T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-04-15T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-04-17T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Endurance Tarde 15h' LIMIT 1), '2026-04-21T15:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Sprint Tarde 18h30' LIMIT 1), '2026-04-22T18:30:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Power Ride Manha 07h' LIMIT 1), '2026-04-24T07:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
    "INSERT INTO aula_realizada (aluno_id, turma_id, data, ativo) SELECT id, (SELECT id FROM turma WHERE nome = 'Cadencia Manha 09h' LIMIT 1), '2026-04-25T09:00:00', 1 FROM aluno WHERE LOWER(email) = 'aluna@gmail.com'",
  ];
